...
/*:
 * @target MZ
 * @plugindesc (v1.0) Features a HP meter for bosses.
 * @author Moghunter
 ...
 * @desc Present HP in numbers.
 * @default true
 * @type boolean
 *
 * @param Show Face
 * @desc Present the face of the enemy.
 * @default true
 * @type boolean
 *
 * @param Slant Animation
 * @desc Activate the Flow animation on the HP meter.
 * @default true
 * @type boolean
 *
 * @param Flow Speed
 * @desc Setting animation speed.
 * @default 4
 * @type number
 *  
 ...
 * 
 * @param Layout X-Axis
 * @desc X-Axis position of the layout.
 * @default 150
 *
 * @param Layout Y-Axis
 * @desc Y-Axis position of the layout.
 * @default 10
 *
 * @param Name X-Axis
 ...
 *
 * @param Name Y-Axis
 * @desc Y-Axis position of the number.
 * @default 23   
 *
 * @param Face X-Axis
 ...
 * @desc Display the number as a percentage.
 * @default false
 * @type boolean
 *
 * @param Show States
 * @desc Display condition icons.
 * @default true
 * @type boolean
 *
 * @param States Max
 * @desc Maximum number of visible icons.
 * @default 8
 * @type number
 * 
 * @param States X-axis
 * @desc X-Axis position of the codes.
 * @default 50
 * 
 * @param States Y-axis
 * @desc Y-Axis position of conditions.
 * @default -8
 * 
 * @command BossHP_Setup
 * @desc Basic Meter Definition.
 * @text Setup
 *
 * @arg x_axis
 * @desc Sets the X-Axis position of the meter.
 * @text X-Axis
 * @default 150
 *
 * @arg y_axis
 * @desc Sets the Y-Axis position of the meter.
 * @text Y-Axis
 * @default 150
 *
 * @arg visible
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Boss HP Meter (v1.0) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/09/13
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Features a HP meter for bosses.
 *
 * =============================================================================
 * - IMAGES
 * =============================================================================  
 * Files that will be needed. (img/bosshp/)
 *
 * Boss_HP_A.png
 * Boss_HP_B.png
 * Boss_HP_C.png
 ...
 * - ENEMIES NOTETAGS
 * ============================================================================= 
 * Use the Tag below in the note box to define which enemies will have the
 * boss meter.
 *
 * Boss HP
 *
 ...
 * - FACE NAME
 * =============================================================================
 * Name the enemies' faces as follows.
 *
 * Face_ + ID.png
 *
 * EG
