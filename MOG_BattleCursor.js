...
/*:
 * @target MZ
 * @plugindesc (v1.0) Add target cursor.
 * @author Moghunter
 ...
 * @desc floating animation.
 * @type boolean
 * @default true
 *
 * @param Align for Actor
 * @parent -> GENERAL
 * @desc Setting cursor alignment on allies. 
 * @text Align (Actor)
 * @type select
 * @default Above
 * @option Below
 ...
 * @parent -> GENERAL
 * @desc Setting cursor alignment on enemies. 
 * @text Align (Enemy)
 * @type select
 * @default Center
 * @option Below
 ...
 * @desc X-axis definition of the cursor on allies.
 * @default 0
 *
 * @param Y-Axis Offset Actor
 * @parent -> GENERAL
 * @text Y-Axis Offset (Actor)
 * @desc Cursor Y-axis setting on allies.
 * @default 0
 *
 * @param X-Axis Offset Enemy
 * @parent -> GENERAL
 * @text X-Axis Offset (Enemy)
 * @desc X-axis definition of the cursor on enemies.
 * @default 0
 *
 * @param Y-Axis Offset Enemy
 * @parent -> GENERAL
 * @text Y-Axis Offset (Enemy)
 * @desc Y-axis definition of the cursor on enemies.
 * @default 0
 * 
 * @param -----------------------
 * @desc
 ...
 * @parent -> NAME
 * @text X-Axis Offset (Actor)
 * @desc X-axis definition of the name in allies.
 * @default 0
 *
 * @param Name Y-Axis Actor
 * @parent -> NAME
 * @text Y-Axis Offset (Actor)
 * @desc Y-axis definition of the name in allies.
 * @default 0
 *
 * @param Name X-Axis Enemy
 * @parent -> NAME
 * @text X-Axis Offset (Enemy)
 * @desc X-axis definition of name on enemies.
 * @default 0
 *
 * @param Name Y-Axis Enemy
 * @parent -> NAME
 * @text Y-Axis Offset (Enemy)
 * @desc Y-axis definition of the name in enemies.
 * @default 0
 *
 * @param ------------------------
 * @desc
 ...
 * @parent -> ANIMATED
 * @text Frames
 * @desc Defining the number of frames.
 * (2..100)
 * @type number
 * @default 3
 * @min 2
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Battle Cursor + (English Translastion) +++
 ...
 * USAGE
 * =============================================================================
 * Images that will be needed. (/img/system/)
 *
 * BattleCursor_A.png
 * BattleCursor_B.png
 * 
 ...
 * NOTETAGS
 * =============================================================================
 * If you want to set a specific cursor position on certain enemies
 * use the notes below.
 * 
