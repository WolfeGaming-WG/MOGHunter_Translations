...
/*:
 * @target MZ
 * @plugindesc (v1.0) Features a touch animation.
 * @author Moghunter
 ...
 * @desc Definition of the number of particles. (1 - 999)
 * @type number
 * @default 10
 * @min 1
 * @max 999
 ...
 * @param X-Axis Offset
 * @text X-Axis Offset
 * @desc Animation X-axis definition. 
 * @default 0
 *
 * @param Y-Axis Offset
 * @text Y-Axis Offset
 * @desc Animation Y-axis definition. 
 * @default 0
 *
 * @param Blend Mode
 ...
 * @param Duration
 * @text Duration
 * @desc Defining the animation time. (1 - 999) 
 * @type number
 * @default 10
 * @min 1
 * @max 999
 ...
 * @param Fade Speed
 * @text Fade Speed
 * @desc Setting the fade speed. (2 - 125)
 * @type number
 * @default 20
 * @min 2
 * @max 125
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Touch Animation + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Features a touch animation.
 * Save the image "TouchParticles.png" in the /img/system/ folder
 *
 */
