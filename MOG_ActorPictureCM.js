...
/*:
 * @target MZ
 * @plugindesc (v1.0) Displays character image during command selection.
 * @author Moghunter
 ...
 * @parent -> BUST <<<<<<<<<<<<<<<<<<<<<<<
 * @desc X-Axis glide definition.
 * @default -150
 *
 * @param Bust Slide Y
 * @text Slide Animation Y
 * @parent -> BUST <<<<<<<<<<<<<<<<<<<<<<<
 * @desc Definition of Y-Axis glide.
 * @default 0  
 *
 * @param Breath Effect
 ...
 * @parent -> BUST <<<<<<<<<<<<<<<<<<<<<<<
 * @type boolean 
 * @desc Activate breath breathing.
 * @default false
 *
 * @param
 * 
 ...
 * @desc Change the character graphic.
 * @text FileName (Bust)
 *
 * @arg id
 ...
 *
 * @arg breath
 * @desc Activate the breathe effect.
 * @text Breath Effect
 * @default false
 * @type boolean
 * 
 * @arg visible
 * @desc Show or hide the image.
 * @text Visible
 * @default true
 * @type boolean 
 *
 * @command ActorPicture_setFileName2
 * @desc Change Support character graphic.
 * @text FileName (Sup)
 *
 * @arg id
 * @desc Character ID definition
 * @text Id
 * @default 1
 * @type number
 * @min 1
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Action Picture CM (v1.0) + (English Translation) +++
 * Author   -   WolfeGaming-WG
 * Version  -   1.0
 * Updated - 2023/08/28 
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Displays character image during command selection.
 *
 * =============================================================================
 * - REQUIRED FILES - 
 * =============================================================================
 * Character images must be saved in the folder. /img/actor_picture_cm/
 * File naming should be done as follows.
 * 
 * Actor_ + ID + _bust.png
 *
 * Exemplo
 ...
 * ----------------------------------------------------------------------------
 *
 * To define the secondary image of the character name the file as follows
 * form.
 *
 * -> Actor_ ID + _sub.png
 *
