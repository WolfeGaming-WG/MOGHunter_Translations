...
/*:
 * @target MZ
 * @plugindesc (v1.0) Adds the battle camera effect.
 * @author Moghunter
 ...
 * @desc Setting the time to activate focus on target.
 * @type number
 * @default 20  
 * @min 0
 * @max 100
 *
 * @param Cam X-Axis
 * @desc Camera X-axis setting.
 * @default 0
 *
 * @param Cam Y-Axis
 * @desc Camera Y-axis setting.
 * @default 0
 * 
 * @command set_bCamWave
 * @desc Configure the Wave effect.
 * @text Wave Effect
 *
 * @arg waveX
 * @desc Enable horizontal wave effect.
 * @text Horizontal Wave
 * @type boolean
 * @default true
 * 
 * @arg waveSpeedX
 * @desc Setting the wave speed.
 * @text Wave Speed
 * @type number
 * @default 100
 * @min 50
 ...
 *
 * @arg waveY
 * @desc Enable vertical wave effect
 * @text Vertical Wave
 * @type boolean
 * @default true
 * 
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Battle Camera + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Adds the battle camera effect.
 *
 */
