...
/*:
 * @target MZ
 * @plugindesc (v1.0) Adds animated effects to battlers.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Default Damage Motion
 * @desc Definition of animation when taking damage.
 * @default 0
 * @type select
 * @option Shake
 * @value 0
 ...
 * @desc Activate tremble effect on ally.
 * @default true
 * @type boolean 
 *
 ...
 * @desc Disable the effect of blinking the battler on damage.
 * @default true
 * @type boolean
 *
 * @param Actor Action Motion
 * @desc Enable Action Motion for in Group.
 * @default false
 * @type boolean
 *
 * @param Enemy Action Motion
 * @desc Activate Action Motion stops on enemies.
 * @default true
 * @type boolean
 *
 * @param Shadow (Float Motion)
 * @desc Activate shadow on levitate move.
 * @default true
 * @type boolean
 *
 * @param Shadow Opacity
 * @desc Shadow transparency setting.
 * @default 170
 * @type boolean
 *
 * @param Shadow Zoom Effect
 * @desc Enable shadow zoom effect.
 * @default true
 * @type boolean
 *
 * @param Battleback Ground Height
 * @desc The value sets the Y-axis threshold of the shadow based on the battleback.
 * @default 200
 * @type number
 *
 * @help  
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Battler Motion + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Adds animated effects to battlers.
 *
 * =============================================================================
 * - IDLE MOTION -      (Enemy Notetags)
 * =============================================================================
 * To activate the effects of animations in standby position use the Tags below
 * in the battlers note box.
 *
 * breath motion : X
 * 
 *      0 -  Vertical Zoom
 ...
 * =============================================================================
 * Use the tags below to force the battlers position.
 *
 * X Offset : X
 * Y Offset : Y
 *
 ...
 * =============================================================================
 * To activate the effects of action animations use the Tags below in the box
 * of skill notes.
 *
 * Action Motion : X
 *
