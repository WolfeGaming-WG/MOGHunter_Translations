...
/*:
 * @target MZ
 * @plugindesc (v1.0) Character sprite animation system.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @command CharIddleMotionEvent
 * @desc Defines the animation for the event.
 * @text Iddle Motion (Event)
 *
 * @arg id
 * @desc Defines the event ID.
 * @text Event ID
 * @default 1
 * @type number
 * @min 1
 *
 * @arg motion
 * @desc Defines the animation of the event.
 * @text Motion
 ...
 * @desc Sets animation for player and allies.
 * @text Iddle Motion (Player)
 *
 * @arg id
 * @desc Sets the player's Index.
 * @text Player Index
 * @default 1
 * @type number
 * @min 1
 ...
 * @desc Activates the shake effect on the event.
 ...
 * @desc Activates the shake effect on the player.
 ...
 * @desc Activates the rotation effect on the event.
 ...
 *
 * @arg angle
 * @desc Angle definition.
 * @text Angle
 * @default 90
 * 
 * @command CharRotationMotionPlayer
 * @desc Activates the rotation effect on the player.
 ...
 * @desc Activates the zoom effect on the event.
 ...
 * @desc Activates the zoom effect on the player.
 ...
 * @desc Activates the collapse effect on the event.
 ...
 * @desc Activates the Collapse effect on the player.
 ...
 *
 * @arg collapse
 * @desc Defines the type of collapse.
 * @text Effect
 * @default Vertical Collapse
 * @type select
 * @option Vertical Collapse
 ...
 *
 * @arg id
 * @desc Sets player ID and allies.
 * @text Player ID
 * @default 1
 * @type number
 * @min 1
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Character Motion (v1.0) + (English Translastion) +++
 ...
 * USE
 * =============================================================================
 * To activate the effects on events, just use this comments.
 *
 * Breath Motion 1
 *  
 * Breath Motion 2
