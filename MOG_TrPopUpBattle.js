...
/*:
 * @target MZ
 * @plugindesc (v1.0) Displays treasure icons after enemy dies.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Drop Item Real Time
 * @desc Win the item in real time.
 * @type boolean 
 * @default true 
 *
 ...
 *
 * @param Fade Duration
 * @desc Time to make the item disappear.
 * @type number
 * @default 20
 * @min 5
 *
 ...
 * =============================================================================
 * Displays treasure icons after enemy dies.
 *
 */
