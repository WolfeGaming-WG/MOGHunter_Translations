...
/*:
 * @target MZ
 * @plugindesc (v1.0) Adds multiple battlebacks on the battlefield.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @command set_bbex1
 * @desc Activate battleback EX (Back).
 * @text Setup (Below)
 *
 * @arg id
 ...
 *
 * @arg filename
 * @desc Definition of battleback name.
 * @text File Name
 * @default GrassMaze
 * @type file
 ...
 *
 * @arg camRate
 * @desc camera depth effect.
 * (Requires Mog_BattleCamera)
 * @text Camera Rate
 * @type number
 * @default 100
 * @min 50
 ...
 *
 * @arg camWaveX
 * @desc Allow Wave Effect horizontally.
 * (Requires Mog_BattleCamera)
 ...
 *
 * @command set_bbex2
 * @desc Activate battleback EX (Front).
 * @text Setup (Above)
 *
 * @arg id
 * @desc Index definition (0..20)
 ...
 *
 * @command remove_bbex
 * @desc Remove the battleback.
 * @text Remove
 *
 * @command remove_bbex_all
 * @desc Removes all battlebacks (EX).
 * @text Clear All
 *
 * @help
 * =============================================================================
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Battleback EX + (English Translastion) +++
