...
/*:
 * @target MZ
 * @plugindesc (v1.0) Allows you to customize the selection image.
 * @author Moghunter
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - MenuCursorBackground + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Allows you to customize the selection image.
 * Save the image "CursorBackground.png" in the /img/menus/ folder
 *
 */
