...
/*:
 * @target MZ
 * @plugindesc (v1.0) Displays a window with the name of the action.
 * @author Moghunter
 ...
 *
 * @param Name X-Axis
 * @desc Name's X-Axis Position.
 * @default 0
 *
 * @param Name Y-Axis
 * @desc Name Y-Axis Position.
 * @default 24 
 *
 * @param Icon X-Axis
 ...
 * =============================================================================
 * Displays a window with the name of the action.
 * It will be necessary to have the file. (img/system/)
 *
 * ActionName.png
 *      
 * =============================================================================
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Action Name (v1.0) + (English Translation) +++
 ...
 * any name, use the comment below in the Item/Skill notes box.
 * 
 * Disable Name
 *
 */
