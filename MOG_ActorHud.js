...
/*:
 * @target MZ
 * @plugindesc (v1.1) Displays a Hud with the character's parameters.
 * @author Moghunter
 ...
 *
 * @param Hud X-Axis
 * @desc Definition of the X-Axis position of the Hud.
 * @default 0
 * @type number 
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Hud Y-Axis
 * @desc Definition of the Hud Y-Axis position.
 * @default 440
 * @type number
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Smart Fade
 * @desc Enable hud transparency when hud is above character.
 * @default true
 * @type boolean
 ...
 *
 * @param Auto Fade
 * @desc Hide hud when massage window is on.
 * @default true
 * @type boolean
 * @on Window Message
 * @off Always Visible 
 ...
 * @desc Present second layout above gauges and face.
 * @default false
 * @type boolean
 * @on Show
 * @off Hide
 ...
 * @desc Sets the gradient animation speed.
 ...
 * @desc Definition of alignment of numbers.
 ...
 * @desc One icon equals 2 HP points.
 * @default false
 * @type boolean 
 ...
 * @desc Number of icon colors.
 * The image will be divided by the number of colors.
 * @default 2
 * @type number
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param HP Icon Max Rows
 * @desc Number of icons per line.
 * @default 10
 * @type number
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc X-Axis quantity of icons.
 * @default 143
 * @type number
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param HP Icon Y-Axis
 * @desc Y-Axis quantity of icons.
 * @default 85
 * @type number
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param HP Icon Space X
 * @desc Setting the space between icons horizontally.
 * @default 0
 * @type number
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param HP Icon Space Y
 * @desc Setting the space between icons vertically.
 * @default 0
 * @type number
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param HP Icon Zoom Anime
 * @desc Enable zoom animation on last icon.
 * @type boolean 
 * @on Enable
 * @off Disable  
 * @default true
 ...
 * @desc One icon equals 2 points of MP.
 * @default false
 * @type boolean 
 * @on Enable (Zelda Style)
 * @off Disable 
 ...
 * @text Gauge Y-Axis
 * @desc Definition of the TP meter Y-Axis position.
 * @default 145
 * @type number
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc Definition of the X-Axis position of the number of TP.
 * @default 270
 * @type number
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param TP Number Y-Axis
 * @desc Definition of the Y-Axis position of the number of TP.
 * @default 130
 * @type number
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc One icon equals 2 points of TP.
 * @default false
 * @type boolean 
 * @on Enable (Zelda Style)
 * @off Disable 
 ...
 * @desc Definition of the X-Axis position of the meter EXP.
 * @default 127
 * @type number
 * @parent -> EXP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param EXP Meter Y-Axis
 * @desc Definition of the Y-Axis position of the meter EXP.
 * @default 173
 * @type number
 * @parent -> EXP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 *
 * @param States X-Axis
 * @desc Definition of the X-Axis position of conditions.
 * @default 5
 * @type number
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param States Y-Axis
 * @desc Definition of the Y-Axis position of conditions.
 * @default 64
 * @type number
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * UNOFFICIAL VERSION 
 * =============================================================================
 * +++ MOG Actor HUD (v1.1) + (English Translation) +++
 * Author   -   WolfeGaming-WG
 * Version  -   1.1
 * Updated - 2023/08/28 
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Adds a Hud with character parameters.
 *
 * =============================================================================
 * - REQUIRED FILES
 * =============================================================================
 * Files will be needed. (img/actorhud/)
 *
 * HP_Meter.png
 * HP_Number.png
 * MP_Meter.png
 ...
 * * HISTORIC
 * =============================================================================
 * (v1.1) Correction in sort function related to codification.       
 *
 */
