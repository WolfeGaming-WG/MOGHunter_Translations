 ...
 *
 * @arg mode
 * @desc Defines the animation of the particle.
 * @text Animation
 * @default Normal
 * @type select
 * @option Normal
 ...
 *
 * @arg power
 * @desc Definition of the amount of particles.
 ...
 * 
 * @arg position
 * @desc Definition of particle position.
 * @text Position
 * @default Feet
 * @type select
 * @option Feet
 ...
 *
 * @arg x
 * @desc Sets the X-axis speed of the shatter.
 * @text X Speed (Offset)
 * @default -1 
 *
 * @arg y
 * @desc Sets the Y-axis speed of the shatter.
 * @text Y Speed (Offset)
 * @default -1 
 *
 * @arg fileName
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Char Particles (v1.0) + (English Translastion) +++
 ...
 * EVENT COMMENT
 * =============================================================================
 * To activate the particle effect use this comment.
 *
 ...
 *      0 - Normal
 *      1 - Add
 * X - Particle velocity horizontally.
 * Y - Particle velocity vertically.
 * POSITION - Position.
 *           0 - Below.
 *           1 - Center.
 *           2 - Above.
 * FILE NAME - Definition of file name.
 *      (The images must be saved in the folder /img/charparticles/)  
 * 
 */
