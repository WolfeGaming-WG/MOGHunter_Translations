...
/*:
 * @target MZ
 * @plugindesc (v1.0) Add borders in command selection.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 * 
 * @param Border Visible
 * @desc Present the edge.
 * @type boolean  
 * @default true
 * 
 * @param Border Line Visible
 * @desc Display the edge line.
 * @type boolean  
 * @default true
 * 
 ...
 * @desc X-axis definition of the cursor edge.
 * @default 4
 *
 * @param Border Y-Space
 * @desc Y-axis definition of the cursor edge.
 * @default 4
 *   
 * @help  
 * =============================================================================
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Menu Cursor Border + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Add borders in command selection.
 * =============================================================================
 * USAGE
 * =============================================================================
