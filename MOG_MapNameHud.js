...
/*:
 * @target MZ
 * @plugindesc (v1.1) Displays a Hud with the map name.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Hud X-Axis
 * @desc Setting the Hud's X-Axis Position.
 * @default 250
 *
 * @param Hud Y-Axis
 * @desc Setting the Hud Y-Axis Position.
 * @default 60
 *
 * @param Name X-Axis
 ...
 *
 * @param Duration
 * @desc Setting the presentation time.
 * @default 160
 *
 * @param Font Size
 ...
 * @desc Enable zoom animation for text only.
 * @default true
 * 
 * @param Particle Animation
 * @desc Enable particle animation.
 * @default true
 *
 ...
 * @desc Enable Circle Animation.
 * @default true
 *
 * @param Circle X-Axis
 * @desc X-axis definition of the circle.
 * @default -120
 *
 * @param Circle Y-Axis
 * @desc Y-axis definition of the circle.
 * @default 0
 *
 * @param Circle Z-Index
 * @desc Circle Z-index definition.
 * 0 - Below Layout / 1 Above Layout.
 * @default 0
 *
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG Map Name Hud (v1.1) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Displays a Hud with the map name.
 * The files that will be needed. (img/system/)
 *
 * MapName.png
 * MapName_Circle.png
