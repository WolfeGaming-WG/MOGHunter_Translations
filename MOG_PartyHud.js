...
/*:
 * @target MZ
 * @plugindesc (v1.1) Displays Huds with the basic conditions of the group.
 * @author Moghunter
 ...
 * 
 * @param Start Visible
 * @desc Display Hud when starting the game.
 * @default true
 * @type boolean
 ...
 * 
 * @param Smart Fade
 * @desc Hide hud when hud overlays character.
 * @default true
 * @type boolean
 ...
 * 
 * @param Name Visible
 * @desc Display the name
 * @default true
 * @type boolean
 * @parent -> NAME <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param Name X
 * @desc X-Axis position of the name.
 * @default 5
 * @type number 
 * @parent -> NAME <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param Name Y
 * @desc Y-Axis position of the name.
 * @default -28
 * @type number
 * @parent -> NAME <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Name Align
 * @desc Defining number alignment.
 ...
 * 
 * @param Face X
 * @desc X-Axis Position of the Face.
 * @default 5
 * @type number 
 * @parent -> FACE <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param Face Y
 * @desc Y-Axis Position of the Face.
 * @default 23
 * @type number 
 * @parent -> FACE <<<<<<<<<<<<<<<<<<<<<<<
 * 
 ...
 * @type boolean
 * @desc Activate HP Meter.
 * @default true
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param HP Meter X
 * @desc HP Meter X-Axis Definition.
 * @default 52
 * @type number 
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param HP Meter Y
 * @desc HP Meter Y-Axis Definition.
 * @default 33
 * @type number 
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param HP Number Visible
 * @desc Activate HP number.
 * @default true
 * @type boolean
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param HP Number X
 * @desc HP Number X-Axis Definition.
 * @default 90
 * @type number 
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param HP Number Y
 * @desc HP Number Y-Axis Definition.
 * @default 12
 * @type number 
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc Activate MP meter.
 * @default true
 * @type boolean
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param MP Meter X
 * @desc MP Meter X-Axis Setting.
 * @default 52
 * @type number 
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param MP Meter Y
 * @desc MP Meter Y-Axis Setting.
 * @default 57
 * @type number 
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param MP Number Visible
 * @desc Activate MP number.
 * @default true
 * @type boolean
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param MP Number X
 * @desc MP Number X-Axis Definition.
 * @default 90
 * @type number 
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param MP Number Y
 * @desc Y -Axis definition of MP number.
 * @default 36
 * @type number 
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc Activate TP meter.
 * @default false
 * @type boolean
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param TP Meter X
 * @desc TP Meter X-Axis Definition.
 * @default 52
 * @type number 
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param TP Meter Y
 * @desc TP Meter Y-Axis Definition.
 * @default 82
 * @type number 
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *  
 * @param TP Number Visible
 * @desc Activate TP number.
 * @type boolean
 * @default false
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param TP Number X
 * @desc TP number X-Axis definition.
 * @default 90
 * @type number 
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param TP Number Y
 * @desc Definition of the Y-Axis of the TP number.
 * @default 66
 * @type number 
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 *  
 * @param LV Number X
 * @desc Definition of the level's X-Axis.
 * @default 30
 * @type number 
 * @parent -> LV <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param LV Number Y
 * @desc Definition of the level's Y-Axis.
 * @default 4
 * @type number 
 * @parent -> LV <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 *  
 * @param Exp Visible
 * @desc Activate the experience.
 * @default true
 * @type boolean
 * @parent -> EXP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Exp X
 * @desc Definition of exp X-Axis.
 * @default 30
 * @type number 
 * @parent -> EXP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param Exp Y
 * @desc Exp Y-Axis Definition.
 * @default 71
 * @type number 
 * @parent -> EXP <<<<<<<<<<<<<<<<<<<<<<<
 * 
 ...
 * @desc Activate conditions.
 * @default true
 * @type boolean
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param States X
 * @desc Definition of the X-Axis of conditions.
 * @default 4
 * @type number 
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param States Y
 * @desc Definition of the Y-Axis of conditions.
 * @default 24
 * @type number 
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param States Scale
 * @desc Conditions sprite Scale/Zoom.
 * @default 70
 * @type number 
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 * 
 ...
 * @desc Hud X-Axis Definition.
 * @default 0
 * @type number  
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 * 
 * @param Hud 1 Position Y
 * @desc Hud Y-Axis Definition.
 * @default 390
 * @type number 
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Party HUD + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Displays Huds with the character's basic parameters.
 *
 * =============================================================================
 * - REQUIRED FILES
 * =============================================================================
 * Save the images to the /img/partyhud/ folder
 ...
 *
 * =============================================================================
 * To name the faces of the battlers, simply name them as follows.
 *
 * Face_ + ACTOR_ID.png
 *
 * Face_1.png
 ...
 * * HISTORY
 * =============================================================================
 * (v1.1) Correction in the sort function related to coding.       
 *
 */
