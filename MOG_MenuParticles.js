...
/*:
 * @target MZ
 * @plugindesc (v1.0) Add particles to menu scenes.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 * 
 * @param File Name
 * @text File Name
 * @desc Setting the file name.
 * @type file
 * @dir img/menus/
 * @default Particles
 * 
 ...
 * @desc Definition of the number of particles. 
 * @type number
 * @default 15
 * @min 5
 * @max 1000
 ...
 * @text Disable Scenes
 * @desc Definition of scenes that will have the effect deactivated.
 ...
 * @desc Each scene will have a different particle image. 
 * @type boolean 
 * @default false
 *
 * @param X-Axis Speed
 ...
 * @text Rotation Speed 
 * @desc Setting the rotation speed. 
 * @default 1
 *
 * @param Blend Mode
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Menu Particles + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Add particles to menu scenes
 * It is possible to activate a different particle for each scene or deactivate the 
 * particle in specific scenes.
 * =============================================================================
 * The particle images should be in the /img/menus/ folder
 * =============================================================================
 * If the Unique Particles option is activated, each particle must 
 * follow this appointment.
 *
 * SCENE_NAME + _par.png
 *
 * Example.
