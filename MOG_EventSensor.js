...
/*:
 * @target MZ
 * @plugindesc (v1.0) event distance system.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Self Switch Key
 * @desc SelfSwitch Key Definition
 * @default D
 * 
 * @help  
 * =============================================================================
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Event Sensor (v1.0) + (English Translastion) +++
 ...
 * Depending on the distance between the player and the event, the predetermined page 
 * of the event can be activated or not.
 * =============================================================================
 * To set the sensor distance from the event put this comment in the
 * event.
 *
 * event sensor : X
 *
