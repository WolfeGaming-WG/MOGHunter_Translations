...
/*:
 * @target MZ
 * @plugindesc (v1.0) The plugin allows you to change the menu background image.
 * @author Moghunter
 ...
 * @desc Setting window transparency.
 * @type number 
 * @default 0
 * @min 0
 * @max 255
 *
 * @param Scroll X-Axis
 * @desc Setting horizontal swipe speed. 
 * @default 0
 *
 * @param Scroll Y-Axis
 * @desc Setting vertical swipe speed. 
 * @default 0
 *
 ...
 * @desc Setting the vertical swipe speed.
 * @default 0
 *
 * @help
 * =============================================================================
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Menu Background + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * The plugin allows you to change the menu background image.
 *
 * =============================================================================
 * The background images should be located in the /img/menus/ folder
 * =============================================================================
 * 
 */
(() => {
