...
/*:
 * @target MZ
 * @plugindesc (v1.0) Adds an animated cursor to the command menu.
 * @author Moghunter
 ...
 * @parent -> GENERAL
 * @text File Name
 * @desc Defining the image file name.
 * @type file
 * @dir img/menus/
 * @default Cursor_A
 *
 ...
 * @parent -> GENERAL
 * @text Show Selection
 * @desc Present default cursor selection.
 * @type boolean
 * @default true
 *
 ...
 * @desc Enable slide animation (Slide).
 * @type boolean
 * @default true
 *
 * @param Move Speed %
 * @parent -> GENERAL
 * @text Slide Speed %
 * @desc Setting the cursor speed. (30% -> 1000%)
 * @type number
 * @min 30
 * @max 1000 
 * @default 100
 ...
 * @parent -> GENERAL
 * @text Animated (Speed %)
 * @desc Setting the speed of the animated cursor. (30% -> 500%)
 * @type number
 * @min 30
 * @max 500
 * @default 100
 ...
 * @desc Enable horizontal animation.
 * @type boolean
 * @default true
 *
 * @param Wave Vertical
 * @parent -> WAVE ANIMATION
 * @text Vertical Wave
 * @desc Enable vertical animation.
 * @type boolean
 * @default false
 *
 * @param Wave Range
 * @parent -> WAVE ANIMATION
 * @text Range
 * @desc Definition of the animation space. (5 -> 50)
 * @type number
 * @min 5
 * @max 50
 * @default 15
 ...
 * @parent -> WAVE ANIMATION
 * @text Speed %
 * @desc Setting the animation speed. (30% -> 400%)
 * @type number
 * @min 30
 * @max 400
 * @default 100
 ...
 * @desc Enable rotation animation.
 * @type boolean
 * @default false
 *
 ...
 * @parent -> ROTATION ANIMATION
 * @text Speed %
 * @desc Setting the rotation speed. (30% -> 1000%)
 * @type number
 * @min 30
 * @max 1000
 * @default 100
 ...
 * @desc Enable particles on cursor.
 * @type boolean
 * @default true
 *
 * @param Par File Name
 ...
 * @desc Definition of the quantity of particles. (5 -> 300)
 * @type number
 * @min 5
 * @max 300
 * @default 30
 ...
 * @parent -> PARTICLES
 * @text X-Axis Offset
 * @desc Particle X-axis Offset definition.
 * @default 0
 *
 ...
 * @parent -> PARTICLES
 * @text X-Axis Speed
 * @desc Defining the speed of particles horizontally.
 * @default -1
 *
 * @param Par SY-Axis
 * @parent -> PARTICLES
 * @text Y-Axis Speed
 * @desc Definition of particle speed vertically.
 * @default -2
 *
 * @command MenuCursorGeneral
 * @desc Command cursor configuration.
 * @text General
 *
 * @arg fileName
 * @text File Name
 ...
 * @desc Wave effect configuration.
 * @text Wave Effect
 * 
 * @arg horzWave
 ...
 * @arg parPower
 * @text Number of Particles
 * @desc Definition of the quantity of particles. (10 -> 300)
 * @type number
 * @min 5
 * @max 300
 * @default 30
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Menu Cursor + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Adds an animated cursor to the command menu.
 *
 * =============================================================================
 * + IMAGES
 * =============================================================================
 ...
 * /img/menus/
 *
 * And save your cursor images in this folder.
 * 
 * =============================================================================
 * + ANIMATED CURSOR
 * =============================================================================
 * To animate the cursor, name the image cursor as follows.
 *
 * FILE_NAME(X).png
 *
 * X - Number of frames.
