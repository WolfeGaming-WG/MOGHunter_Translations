...
/*:
 * @target MZ
 * @plugindesc (v1.1) Features a Hud with treasures acquired in the game.
 * @author Moghunter
 ...
 *
 * @param Icon X-Axis
 * @desc Defining the icon's X-Axis position.
 * @default 42
 *
 * @param Icon Y-Axis
 * @desc Defining the Y-Axis position of the icon.
 * @default 24  
 *
 * @param Duration
 ...
 * @desc Definition of the Index of the icon that represents money.
 * @default 163
 *
 * @param Font Size
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG Treasure Hud (v1.1) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.1
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Features a Hud with treasures acquired in the game.
