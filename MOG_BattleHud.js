...
/*:
 * @target MZ
 * @plugindesc (v1.1) Allows you to customize the battle layout.
 * @author Moghunter
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 * 
 * @param Hud X-Axis
 * @text X-Axis
 * @desc Defining the X-Axis position of the Hud.
 * @default -90
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Hud Y-Axis
 * @text Y-Axis
 * @desc Defining the Hud Y-Axis position.
 * @default 460
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Hud Space X
 * @text Space X
 * @desc Sets the horizontal space between huds.
 * @default 0
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Hud Space Y
 * @text Space Y
 * @desc Sets the vertical space between huds.
 * @default 0
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Hud Slide X
 ...
 * @desc Maximum amount of battler in battle.
 * @type number
 * @min 1 
 * @default 4
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 ...
 * @text Visible
 * @desc Activate the second layout image, this image 
 * will stand above the faces and gauges.
 * @default false
 * @type boolean 
 ...
 * @param Turn X-Axis
 * @text X-Axis
 * @desc Setting the shift X-Axis position.
 * @default 0
 * @parent -> TURN <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Turn Y-Axis
 * @text Y-Axis
 * @desc Setting the shift Y-Axis position.
 * @default 0
 * @parent -> TURN <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @text Zoom Animation
 * @desc Enable zoom animation on launch.
 * @default false
 * @type boolean 
 * @parent -> TURN <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @param Face X-Axis
 * @text X-Axis
 * @desc Defining the X-Axis position of the face.
 * @default 44
 * @parent -> FACE <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Face Y-Axis
 * @text Y-Axis
 * @desc Defining the Y-Axis position of the face.
 * @default 72
 * @parent -> FACE <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param Face Shake Animation
 * @text Shake Animation
 * @desc Enable face shaking animation.
 * @default true
 * @type boolean 
 * @parent -> FACE <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @param Name Visible
 * @text Visible
 * @desc Display the character's name.
 * @default true
 * @type boolean 
 * @parent -> NAME <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Name X-Axis
 * @text X-Axis
 * @desc Defining the X-Axis position of the name.
 * @default 0
 * @parent -> NAME <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param Name Y-Axis
 * @text Y-Axis
 * @desc Defining the Y-Axis position of the name.
 * @default -20
 * @parent -> NAME <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param Name Align
 ...
 * @text Gauge X-Axis
 * @desc Defining the X-Axis position of the HP meter.
 * @default 113
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param HP Meter Y-Axis
 * @text Gauge Y-Axis
 * @desc Defining the Y-Axis position of the HP meter.
 * @default 39
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @desc Enable Gradient Animation on Gauge.
 * The image needs to be 3x the gauge width.
 * @default false
 * @type boolean 
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @desc Definition of the type of alignment of numbers.
 ...
 * @text Number Y-Axis
 * @desc Definition of the Y-Axis position of the number of HP.
 * @default 23
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<< 
 * 
 * @param MaxHP Number Visible
 * @text Max HP Visible
 * @desc Display the number of maximum HP.
 * @default false
 * @type boolean
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @text Gauge X-Axis
 * @desc Setting the X-Axis Position of the MP Meter.
 * @default 125
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param MP Meter Y-Axis
 * @text Gauge Y-Axis
 * @desc Setting the Y-Axis Position of the MP Meter.
 * @default 77
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @text Number Y-Axis
 * @desc Defining the Y-Axis position of the MP number.
 * @default 61
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param MaxMP Number Visible
 * @text Max MP Visible
 * @desc Display the maximum number of MP.
 * @default false
 * @type boolean
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @text Max HP X-Axis
 * @desc Defining the X-Axis position of the maximum MP number.
 * @default 196
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param MaxMP Number Y-Axis
 * @text Max HP Y-Axis
 * @desc Defining the Y-Axis position of the maximum MP number.
 * @default 78
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param
 ...
 * @text Gauge X-Axis
 * @desc Defining the X-Axis position of the TP meter.
 * @default 113
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param TP Meter Y-Axis
 * @text Gauge Y-Axis
 * @desc Defining the TP meter Y-Axis position.
 * @default 115
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @text Number Y-Axis
 * @desc Defining the Y-Axis position of the TP number.
 * @default 99
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @text Max TP X-Axis
 * @desc Definition of the X-Axis position of the maximum number of TP.
 * @default 175
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param MaxTP Number Y-Axis
 * @text Max TP Y-Axis
 * @desc Defining the Y-Axis position of the maximum TP number.
 * @default 99
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @text Gauge X-Axis
 * @desc Setting the X-Axis position of the ATB meter.
 * @default 80
 * @parent -> ATB <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param ATB Meter Y-Axis
 * @text Gauge Y-Axis
 * @desc Setting the Y-Axis position of the ATB meter.
 * @default 140
 * @parent -> ATB <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @text Visible
 * @desc Submit the number and conditions.
 * @default true
 * @type boolean
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param States X-Axis
 * @text X-Axis
 * @desc Defining the X-Axis position of conditions.
 * @default 10
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param States Y-Axis
 * @text Y-Axis
 * @desc Defining the Y-Axis position of conditions.
 * @default 120
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param States Mode
 * @text View Mode
 * @desc Definition of the presented mode of the conditions.
 ...
 * @text Position Mode
 * @desc Enable automatic position-based adjustment
 * of Hud.
 * @type select
 * @option Auto
 * @value 0
 ...
 * @text X-Axis
 * @desc Setting the X-axis position of the command.
 * @default 0
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Command Y-Axis
 * @text Y-Axis
 * @desc Command Y-axis position definition.
 * @default -40
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @text Height
 * @desc Window height setting.
 * @default 0
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Command Slide X
 * @text Slide Animation X
 * @desc X-Axis slide animation.
 * @default 0
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Command Slide Y
 * @text Slide Animation Y
 * @desc Y-Axis slide animation.
 * @default 64
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 * 
 ...
 * @text Layout X-Axis
 * @desc Defining the X-axis position of the layout.
 * @default -20
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Command Y-Axis
 * @text Layout Y-Axis
 * @desc Defining the Y-axis position of the layout.
 * @default -25
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @text X-Axis
 * @desc Setting the X-axis position of the window.
 * @default 325
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Party Y-Axis
 * @text Y-Axis
 * @desc Window Y-axis position setting.
 * @default 170
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Party Width
 ...
 * @text Max Columns
 * @desc Setting the number of columns in the window.
 * @type number
 * @min 1 
 * @default 2
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 ...
 * @param Screen X-Axis
 * @text X-Axis
 * @desc Setting the X-axis position of the image.
 * @default 0
 * @parent -> SCREEN LAYOUT <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Screen Y-Axis
 * @text Y-Axis 
 * @desc Setting the Y-axis position of the image.
 * @default 0
 * @parent -> SCREEN LAYOUT <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG_BattleHud (v1.1) + (English Translastion) +++
 ...
 * - REQUIRED FILES
 * ============================================================================= 
 * Files will be needed. (img/battlehud/)
 *
 * ->  HP_Meter.png
 * ->  HP_Number.png
 * ->  MP_Meter.png
 ...
 *
 * =============================================================================
 * To name the faces of the battlers just name them as follows.
 *
 * Face_ + ACTOR_ID.png
 *
 * Face_1.png
 ...
 * - NOTETAGS
 * =============================================================================
 * To activate the breathing effect on the faces use the notetag below
 *
 * Face Breath Effect
 *
 * =============================================================================
 ...
 *
 * To display the hud use the command below.
 *
