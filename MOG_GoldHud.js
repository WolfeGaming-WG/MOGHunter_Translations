...
/*:
 * @target MZ
 * @plugindesc (v1.1) Displays a Hud with the amount of money.
 * @author Moghunter
 ...
 *
 * @param Number X-Axis
 * @desc Defining Numero's X-Axis position.
 * @default 240
 *
 * @param Number Y-Axis
 * @desc Numero Y-Axis Position Definition.
 * @default 24
 *
 * @param Fade Limit
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG Gold Hud (v1.1) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.1
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Displays a Hud with the amount of money.
 * Files will be required. (img/system/)
 *
 * Gold_A.png
 * Gold_B.png
 *
