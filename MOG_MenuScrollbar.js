...
/*:
 * @target MZ
 * @plugindesc (v1.0) Add a scroll bar to windows.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Always Visible
 * @desc Keep the meter visible at all times.
 * @default true
 *  
 * @param X-Axis
 * @desc Defining the X-Axis position of the bar.
 * @default 0
 *
 * @param Y-Axis
 * @desc Defining the Y-Axis position of the bar.
 * @default 0
 *
 * @param Button X-Axis
 * @desc Defining the X-Axis position of the button.
 * @default 1
 *
 * @param Button Y-Axis
 * @desc Defining the button's Y-Axis position.
 * @default 1
 *
 * @help  
 * =============================================================================
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Menu Scroll Bar + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Add a scroll bar to windows.
 *
 * =============================================================================
 * USAGE
 * =============================================================================
 * Images will be needed. (/img/menus/)
 *
 * ScrollBarA.png
 * ScrollBarB.png
 * 
