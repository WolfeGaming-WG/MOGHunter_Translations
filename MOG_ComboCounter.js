...
/*:
 * @target MZ
 * @plugindesc (v1.0) Displays the number of hits on the target.
 * @author Moghunter
 ...
 *  
 * @param For Party
 * @desc Activate the Hit counter for the group.
 * @default true
 * @type boolean
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<< 
 *  
 * @param For Enemies
 * @desc Activate the hit counter for enemies.
 * @default true
 * @type boolean
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<  
 *  
 * @param Damage Cancel Counter
 * @desc Cancel counter when opponent deals damage.
 * @default true
 * @type boolean
 * @parent -> MAIN <<<<<<<<<<<<<<<<<<<<<<<  
 *  
 ...
 *
 * @param Party X-Axis
 * @desc X-Axis position of the counter for the group.
 * @default 500
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Party Y-Axis
 * @desc Y-Axis position of the counter for the group.
 * @default 90
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Enemies X-Axis
 * @desc X-Axis position of the counter for enemies.
 * @default 0
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Enemies Y-Axis
 * @desc Counter Y-Axis position for enemies.
 * @default 90
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param ----------------------------------------
 ...
 * @desc HIT layout Y-Axis position.
 * @default 34
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc HIT number X-Axis position.
 * @default 115
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @desc Y-Axis position of the DMG number.
 * @default 3
 * @parent -> POSITION <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @help  
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Combo Counter (v1.0) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/09/13
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Displays the amount of Hits when attacking the enemy.
 * Files that will be needed. (img/system/)
 *
 * Combo_A.png
 * Combo_B.png
 * Combo_C.png
