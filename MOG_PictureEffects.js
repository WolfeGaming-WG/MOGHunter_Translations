...
/*:
 * @target MZ
 * @plugindesc (v1.1) The plugin allows you to animate images.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com/
 * 
 * @command set_breath_effect
 * @desc Configures the breathing effect.
 * @text Breath Effect
 *
 * @arg id
 * @desc ID Setting (1..100)
 * @text ID
 * @default 1 
 * @type number
 * @min 1
 ...
 * @desc Configures the hover effect.
 * @text Float Effect
 *
 * @arg id
 * @desc ID Setting (1..100)
 ...
 * @desc Configures the shake effect.
 * @text Swing Effect
 *
 * @arg id
 * @desc ID Setting (1..100)
 ...
 *
 * @arg duration
 * @desc Duration of the shake effect. (20...9999999)
 * @text Duration
 * @default 60 
 * @type number
 * @min 20
 ...
 * @desc Configures the rotate effect.
 * @text Flip Effect
 *
 * @arg id
 * @desc ID Setting (1..100)
 ...
 * 
 * @arg mode
 * @desc Setting the animation mode.
 * @text Mode
 * @type select
 * @default Smooth
 * @option Smooth
 ...
 * @desc Enables collapse animation.
 ...
 *  
 * @arg enabled
 * @desc Activate the effect
 * @text Enabled
 * @type boolean
 * @default true 
 *
 * @command set_quick_move
 * @desc Fast movement to make conversation scenes.
 * @text Quick Move
 *
 * @arg id
 * @desc ID Setting (1..100)
 ...
 * 
 * @arg mode
 * @desc Defining the direction of movement.
 * @text Direction
 * @type select
 * @default Up
 * @option Up
 ...
 *
 * @arg times
 * @desc Number of times of movement. (1..9999999)
 ...
 * @desc Quick zoom to make conversation scenes.
 * @text Quick Zoom
 *
 * @arg id
 * @desc ID Setting (1..100)
 ...
 * 
 * @arg mode
 * @desc Setting the zoom animation.
 * @text Animation
 * @type select
 * @default Zoom Out & In
 * @option Zoom Out & In
 ...
 *
 * @arg times
 * @desc Number of animation times. (1..9999999)
 * @text Number of Times
 * @default 1
 * @type number
 * @min 1
 ...
 *
 * @arg speed
 * @desc Setting the animation speed. (1..7)
 * @text Speed
 * @default 4 
 * @type number
 * @min 1
 ...
 *  
 * @arg speaking
 * @desc Enable speech animation during text message.
 ...
 * 
 * @arg ignore
 * @desc Disable the wave effect in the images below.
 * EX    2,5,7,8,10,30
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Picture Effects + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * The plugin allows you to animate images.
 *
 * =============================================================================
 * SKIT MODE (PICTURES)
 * =============================================================================
 * It will be necessary to have just one image containing the three positions
 * of the character, in this order.
 *
 * Still/Talking/Blinking
 *
 * =============================================================================
 * HISTORY
 * =============================================================================
