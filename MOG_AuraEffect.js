...
/*:
 * @target MZ
 * @plugindesc (v1.0) Adds aura and particle animation to enemies.
 * @author Moghunter
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Aura Effect + (English Translation) +++
 ...
 * The aura and particle images must be recorded on the
 * same folder as the battlers /img/sv_enemies/ or img/enemies/
 *
 * =============================================================================
 ...
 *
 * Z_INDEX - Sets the Z value of the image. (0 a 1) 
 *           0 - Below the battler image
 *           1 - Above the battler image.
 * TYPE - Animation type (0 to 2)
 *        0 - No Animation.
 *        1 - Pulse
 *        2 - Zoom
 * FILE_NAME = File name. (Set to "battler" if you want to use the image of the
  * battler) 
 ...
 *
 * Z_INDEX - Sets the Z value of the image. (0 a 1) 
 *           0 - Below battler image
 *           1 - Above the battler image.
 * POWER - amount of particles.
 * FILE_NAME - File name.
 * BLEND_MODE - Blend type.
 * SPEED_X - X-Axis movement speed.
 * SPEED_Y - Y-Axis movement speed.
 *
 * Example
 * 
