...
/*:
 * @target MZ
 * @plugindesc (v1.0) Adds animated collapse effects.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Default Collapse
 * @desc Definition of standard collapse;
 * (0 to 9) (-1 = No Effect / -2 = Random Effects)
 * @default 1
 * @type select
 ...
 * @desc Setting Collapse direction in mode 0;
 * (Left  / Right)
 * @default Left
 * @type select
 * @option Left
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Collapse Effects + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Adds animated collapse effects.
 *
 * =============================================================================
 * - COLLAPSE EFFECT (SKILL & ENEMY)
 * =============================================================================
 * To force an effect use the tags below in the enemy note box
 * or SKILLs.
 *
 ...
 * =============================================================================
 * To force an animation use the tags below in the enemy note box
 * or SKILLs.
 *
 * Collapse Animation : ANIMATION_ID
 *
 * ANIMATION_ID = Setting the database animation ID.
 *
 */
