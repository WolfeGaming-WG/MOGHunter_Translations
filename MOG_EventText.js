...
/*:
 * @target MZ
 * @plugindesc (v1.0) Add text on top of the event.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param X axis
 * @desc Defining the X-axis position.
 * @default 0
 *
 * @param Y axis
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Event Text (v1.0) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Adds text above the event, useful for making tutorials.
 * =============================================================================
 * To activate the text in the event use the following comment in the event.
 *
 *  event text : TEXT
 *
 * Example.
