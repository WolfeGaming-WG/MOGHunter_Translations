...
/*:
 * @target MZ
 * @plugindesc (v1.0) Features a target's HP meter.
 * @author Moghunter
 ...
 * @desc Display HP in target selection. 
 * @default true
 * @type boolean 
 * 
 * @param Fade Duration
 ...
 * @desc Display the number of HP for the actor. 
 * @default false
 * @type boolean 
 *
 * @param Show HP Number Enemy
 * @desc Display the HP number for the enemy. 
 * @default true
 * @type boolean 
 *
 * @param Required to Kill
 * @desc Requires defeating enemy to show HP. 
 * @default false
 * @type boolean 
 * 
 ...
 * @desc X-Axis position of HP number.
 * @default -25
 *
 * @param Actor HP Number Y-Axis
 * @desc HP Number Y-Axis Position.
 * @default -22
 * 
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - HP Gauge (v1.0) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Features a target's HP meter.
 ...
 * NOTETAGS
 * =============================================================================
 * To hide the enemy's HP use the following Tag in the note box
 *
 * Hide HP
 *
 * -----------------------------------------------------------------------------
 * To adjust the meter position use the Tag below.
 *
 * Hp Gauge Offset: X:Y
 *
 * Example
