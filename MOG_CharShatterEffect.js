...
/*:
 * @target MZ
 * @plugindesc (v1.0) Creates the shatter effect on character sprites.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 * 
 * @command CharShatterEffectEvent
 * @desc Activates the shatter effect on the event.
 ...
 * UNOFFICIAL VERSION
 * =============================================================================
 * +++ MOG - Char Shatter Effect (v1.0) + (English Translastion) +++
 * Author   -   WolfGaming-WG
 * Version  -   1.0
 * Updated  -   2023/08/29
 * https://github.com/WolfeGaming-WG
 * =============================================================================
 * Creates the shatter effect on character sprites.
 *
 */
